...
const Battle = () => {
  ...
  return (
    <div className="flex justify-center items-start pt-20">
      ...
      <TitanBattleCard name="Obsidion" level="1" owner="0x968E51108d076A7d" id="hero-bar" idtxt="hero-bar-txt" url="/obs1.jpg" eq1="/sword.jpg" eq2="/plate.jpg"/>
      ...
      {/* Button Section */}
      <TitanBattleCard name="Private MonKey" level="0" owner="0xAb5801a7D398351" id="villain-bar" idtxt="villain-bar-txt" url="/mon0.jpg" eq1="/empty.png" eq2="/empty.png" />
